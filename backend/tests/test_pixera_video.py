...
def test_osc_befehlliste_matches_video_overview() -> None:
    ...
    osc_paths = resolve_osc_befehlliste_paths_for_scope(data_dir, "part2")
    ...
    for prefix, clip_name in parse_osc_befehlliste_files(osc_paths):
...
def test_pixera_cue_name_mapping() -> None:
    ...
    assert service.pixera_cue_name("led", "inge") == "KI_LED.Inge"
